...
class MainSolution():
    def __init__(self):
        self.image = cv.imread("5b6dff69-788f-48da-a56b-5e715e6ff5e1.jpg")
        self.imgray = None
        self.trsh1 = None
        self.trsh2 = None
...
class Gui:
    def __init__(self, master):
        ...
        self.master.configure(background='indian red')
        ...
        self.label1 = Label(self.frame, text="Result Image", font=(
            "Helvetica", 15), bg='green')
        self.label1.grid(row=0, column=1, padx=10, pady=10)

        self.label5 = Label(self.frame, text="Original Image", font=(
            "Helvetica", 15), bg='green')
        self.label5.grid(row=0, column=2, padx=10, pady=10)
