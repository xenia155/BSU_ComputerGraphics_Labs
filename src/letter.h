...
public:
    ...
    static const int vertices = 39;
    static const int shapeSides = 4;
    static const int shapesNum = 28;
    static const int indexPoints = shapesNum * shapeSides;
    static const int triangleIndexPoints = 8 * 3;

    GLfloat** VertexArray = nullptr;
    GLubyte IndexArray[shapesNum][shapeSides];
    GLubyte TriangleIndexArray[8][3];
    static const GLfloat colorArray[vertices][3];
