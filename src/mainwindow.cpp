...
void MainWindow::on_actionLetter_colour_clikced()
{
...
void MainWindow::on_pushButton_11_clicked()
{
    ...
    QMessageBox::information(this,"Control keys","For interacting with object you can use mosuse or keyboard \n \n "
                                  "To zoom in press + \n \n"
                                                 "zoom - press - \n \n"
                                                 "rotate down - press s \n \n"
                                                 "rotate up - press w \n \n"
                                                 "rotate left - press a \n \n"
                                                 "translate down - press z \n \n"
                                                 "rotate right - press d \n \n"
                                                 "translate up - press x \n \n");
}
